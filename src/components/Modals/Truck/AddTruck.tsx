...
import useAddTrucks from "../../../hooks/useAddTruck";
import z from "zod";
...
const AddDriver = ({ open, onClose, title }: Props) => {
  ...
  const submitHandler = (data: TruckFormData) => {
    console.log(data);
    mutate(data);
  };
        ...
        <div className="overflow-x-auto px-20 py-5">
          <table className="table-auto w-full">
            <tbody>
              ...
              {/* Address */}
              <tr>
                <th className="text-left w-1/4 py-2">Capacity (L)</th>
                <td className="py-2">
                  <input
                    {...register("capacity", { valueAsNumber: true })}
                    type="number"
                    className="input input-bordered w-full"
                    placeholder="eg:- 1000 (Liters)"
                  />
                  {errors.capacity && (
                    <p className="text-sm text-red-600">
              ...
              <tr>
                ...
                <td className="py-2">
                  <input
                    ...
                    type="text"
                    className="input input-bordered w-full"
                    placeholder="eg:- 1000 (Kilometers)"
                  />
